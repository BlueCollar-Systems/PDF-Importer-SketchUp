...
| **Raster** | Verified page Raster for every selected page | None; Raster is already terminal |
...
- Acceptance must cover mixed per-span success/fallback, requested Raster on every selected page, rotated Labels, and save/reopen/source-file deletion in SketchUp 2017 and a current SketchUp release.
