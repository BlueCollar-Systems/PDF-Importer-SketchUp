...
| **WS-RUBY22** | P0 gate | SketchUp extension | **done** — gate shipped | 2026-06-25 | [Ruby 2.2 compat gate](QA-2026-06-24_ruby22-compat-gate.md) · v3.7.68 current release + CI scanner; Joe Campbell unblocked |
...
| **WS-RUBY22** | Joe Campbell / SU 2017 field confirm v3.7.68 loads | Human tester | **P0** — hotfix + gate shipped 2026-06-25 |
