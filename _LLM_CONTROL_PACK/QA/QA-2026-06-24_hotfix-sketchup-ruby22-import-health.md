...
| Version | `3.7.66` in `metadata.rb` and `bc_pdf_vector_importer.rb` (`PLUGIN_VERSION`) |
| README | Version badge updated to 3.7.66 |
...
1. Build or install RBZ **v3.7.66** (local `build_release.py` or CI artifact).
