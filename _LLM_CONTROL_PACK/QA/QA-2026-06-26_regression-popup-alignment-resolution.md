...
## Agreements
- **R26-1:** SketchUp pre-import guidance is show-once per profile (`ImportGuidance`), SketchUp-native copy only.
...
|------|---------|-----------|
| SketchUp | 3.7.74 | `import_guidance.rb`, `main.rb`, `geometry_builder.rb` |
...
- **After:** First import only; preference stored; no LibreCAD mention.
