...
**Date:** 2026-06-25  
**Release:** PDF Vector Importer **v3.7.66** (SketchUp extension)  
**Customer:** Joe Campbell — extension blocked on SketchUp 2017 until v3.7.66 RBZ
...
| `metadata.rb` / loader | Version **3.7.66** |
...
**Customer message:** Install **v3.7.66** from Releases — the extension will not
...
| `build_release.py` | `SketchUp-PDF-Importer_v3.7.66.rbz` |

## Manual retest (Joe / field)

1. Install RBZ **v3.7.66** on SketchUp 2017.
