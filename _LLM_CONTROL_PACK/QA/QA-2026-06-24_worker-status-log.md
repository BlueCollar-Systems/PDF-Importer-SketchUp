...
2026-06-26 01:20 UTC | WS-RPIPE | Codex live-release follow-up | UPDATE | Manual auto-release dispatched. SU v3.7.73, FC v4.0.53, BL v1.0.50 published green. LC v1.0.48 passed tests/build/portable smoke but failed release create with integration-token 403; checkout/publish auth split being committed, then LC will be rerun to refresh latest.
