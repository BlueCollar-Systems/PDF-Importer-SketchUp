...
#   CORPUS_STRICT_TIMING=1 CORPUS_STRICT_TIMING_PDF=T1-01 ruby test/corpus_strict_timing_test.rb
#
...
slug = (ENV['CORPUS_STRICT_TIMING_PDF'] || 'T1-01').strip
...
pdf_path = BlueCollarSystems::PDFVectorImporter::CorpusPaths.resolve_corpus_pdf("tier1/user/#{slug}.pdf") unless pdf_path && File.file?(pdf_path)
