...
MODERN_METHOD_PATTERN =
  /&\.|(?<!\.)\.(?:match\?|casecmp\?|positive\?|negative\?|dig|sum|then|yield_self|filter|filter_map|tally|transform_values|transform_keys|delete_prefix|delete_suffix|fetch_values|chunk_while|clamp|unpack1|digits|grep_v|bsearch_index)(?=[^A-Za-z0-9_]|$)/
