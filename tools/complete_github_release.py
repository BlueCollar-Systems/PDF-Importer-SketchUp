...
class GhClient:
    ...
    def create_release(self, tag, target, title, notes, assets, latest):
        ...
        # Always assemble assets behind a draft boundary. Publishing is a
        # separate, ID-bound operation after exact asset verification, so an
        # interrupted upload can never freeze an incomplete public release.
